...
describe('Sénat elections client', () => {
  it('parses majority T1 sheet with elected candidates', async () => {
    const buf = buildXlsx({
      'MAJ - T1': [
        ...
        [
          'FE', 'France', '39', 'Jura', '39300', 'Lons', '1',
          998, 979, '98,10%', 19, '1,90%', 958, '95,99%', '97,85%',
          13, '1,30%', '1,33%', 8, '0,80%', '0,82%',
          'UDI', 'DUPONT', 'Marie', 'F', '', '', '',
          573, '76,50%', '79,14%', 'élu', '',
          'LR', 'MARTIN', 'Pierre', 'M', '', '', '',
          200, '20,00%', '20,88%', '', '',
  ...
  it('parses majority T2 as round 2', async () => {
    const buf = buildXlsx({
      'MAJ - T2': [
        [
          'Code localisation', 'Libellé localisation',
          ...
          'Sexe candidat 1', 'Nuance liste 1', 'Libellé abrégé de liste 1',
          'Libellé de liste 1', 'Voix 1', '% Voix/inscrits 1',
          '% Voix/exprimés 1', 'Elu 1', 'Sièges 1',
        ],
        [
          'FE', 'France', '52', 'Haute-Marne', '52121', 'Chaumont', '1',
          100, 98, '98%', 2, '2%', 95, '95%', '96,94%',
          1, '1%', '1,02%', 2, '2%', '2,04%',
          'LR', 'SIDO', 'Bruno', 'M', '', '', '',
          60, '60%', '63,16%', 'élu', '',
        ],
